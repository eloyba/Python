...
print("El gasto de abril ha sido de", gasto_abril,"euros")
print("El gasto de mayo ha sido de", gasto_mayo,"euros")
print("El gasto de junio ha sido de", gasto_junio,"euros")